#!/usr/bin/env bash
# Install the freshly built Beacon core + UI into the local LogosBasecamp user dir.
#
...
CORE_LGX="$HERE/core/result-portable/logos-beacon_core-module-lib.lgx"
UI_LGX="$HERE/ui/result-portable/logos-beacon-module.lgx"
...
echo "==> Installing core -> modules/beacon_core"
DEST="$BASE/modules/beacon_core"
mkdir -p "$DEST"
...
echo "    BEACON_TCPPORT=60001 open -n /Applications/LogosBasecamp.app"
